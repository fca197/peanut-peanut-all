 ...
 */
@RestController
public class ApsSchedulingDayConfigVersionDetailMachineUseTimeApiImpl implements
    ApsSchedulingDayConfigVersionDetailMachineUseTimeApi {
  ...
  public @Override ApsSchedulingDayConfigVersionDetailMachineUseTimeImportRes importData(
      @RequestParam("file") MultipartFile file) {
    List<ApsSchedulingDayConfigVersionDetailMachineUseTimeImportReq> reqList = PoiExcelUtil.readData(
        file, new ApsSchedulingDayConfigVersionDetailMachineUseTimeImportListener(),
        ApsSchedulingDayConfigVersionDetailMachineUseTimeImportReq.class);
    // 类型转换，  更换枚举 等操作
    List<ApsSchedulingDayConfigVersionDetailMachineUseTime> readList = $.copyList(reqList,
  ...
  public @Override ApsSchedulingDayConfigVersionDetailMachineUseTimeQueryByIdListRes queryByIdListRes(ApsSchedulingDayConfigVersionDetailMachineUseTimeQueryByIdListReq req) {
    ...
    List<ApsSchedulingDayConfigVersionDetailMachineUseTime> list = this.apsSchedulingDayConfigVersionDetailMachineUseTimeService.list(
        q);
    List<ApsSchedulingDayConfigVersionDetailMachineUseTimeDto> dataList = $.copyList(list,
        ApsSchedulingDayConfigVersionDetailMachineUseTimeDto.class);
    this.apsSchedulingDayConfigVersionDetailMachineUseTimeService.setName(dataList);
    return new ApsSchedulingDayConfigVersionDetailMachineUseTimeQueryByIdListRes().setDataList(
        dataList);
  }
}
