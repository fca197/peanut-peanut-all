...
public class ApsOrderGoodsProjectConfigServiceImpl extends MPJBaseServiceImpl<ApsOrderGoodsProjectConfigMapper, ApsOrderGoodsProjectConfig> implements
  ...
  public @Override ApsOrderGoodsProjectConfigQueryListRes queryList(ApsOrderGoodsProjectConfigQueryListReq req) {
    ...
    List<ApsOrderGoodsProjectConfigDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsOrderGoodsProjectConfigDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsOrderGoodsProjectConfigExportQueryPageListInfoRes> queryPageList(ApsOrderGoodsProjectConfigExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsOrderGoodsProjectConfigExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsOrderGoodsProjectConfigExportQueryPageListInfoRes.class));
    ...
    List<ApsOrderGoodsProjectConfigExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
        ApsOrderGoodsProjectConfigExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsOrderGoodsProjectConfigDto> apsOrderGoodsProjectConfigDtoList) {
  ...
  private MPJLambdaWrapper<ApsOrderGoodsProjectConfig> getWrapper(ApsOrderGoodsProjectConfigDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getOrderId()), ApsOrderGoodsProjectConfig::getOrderId,
              obj.getOrderId())
          .eq(Objects.nonNull(obj.getGoodsId()), ApsOrderGoodsProjectConfig::getGoodsId,
              obj.getGoodsId())
          .eq(Objects.nonNull(obj.getFactoryId()), ApsOrderGoodsProjectConfig::getFactoryId,
              obj.getFactoryId())
