...
public class ApsGoodsForecastMainGoodsDataServiceImpl extends MPJBaseServiceImpl<ApsGoodsForecastMainGoodsDataMapper, ApsGoodsForecastMainGoodsData> implements
  ...
  public @Override ApsGoodsForecastMainGoodsDataQueryListRes queryList(ApsGoodsForecastMainGoodsDataQueryListReq req) {
    ...
    List<ApsGoodsForecastMainGoodsDataDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsGoodsForecastMainGoodsDataDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsGoodsForecastMainGoodsDataExportQueryPageListInfoRes> queryPageList(ApsGoodsForecastMainGoodsDataExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsGoodsForecastMainGoodsDataExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsGoodsForecastMainGoodsDataExportQueryPageListInfoRes.class));
    ...
    List<ApsGoodsForecastMainGoodsDataExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
        ApsGoodsForecastMainGoodsDataExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsGoodsForecastMainGoodsDataDto> apsGoodsForecastMainGoodsDataDtoList) {
  ...
  private MPJLambdaWrapper<ApsGoodsForecastMainGoodsData> getWrapper(ApsGoodsForecastMainGoodsDataDto obj) {
    ...
    LambdaQueryUtil.lambdaQueryWrapper(q, obj, ApsGoodsForecastMainGoodsData.class,
        ApsGoodsForecastMainGoodsData::getGoodsId, ApsGoodsForecastMainGoodsData::getYear,
        ApsGoodsForecastMainGoodsData::getForecastMainId);
