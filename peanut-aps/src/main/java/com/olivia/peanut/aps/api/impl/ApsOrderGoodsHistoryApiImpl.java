...
public class ApsOrderGoodsHistoryApiImpl implements ApsOrderGoodsHistoryApi {
  ...
  public @Override ApsOrderGoodsHistoryQueryByIdListRes queryByIdListRes(ApsOrderGoodsHistoryQueryByIdListReq req) {
    MPJLambdaWrapper<ApsOrderGoodsHistory> q = new MPJLambdaWrapper<ApsOrderGoodsHistory>(ApsOrderGoodsHistory.class).selectAll(ApsOrderGoodsHistory.class)
        .in(ApsOrderGoodsHistory::getId, req.getIdList());
