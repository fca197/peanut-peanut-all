...
public interface ApsGoodsForecastUserGoodsDataApi {
  ...
  ApsGoodsForecastUserGoodsDataInsertRes insert(
      @RequestBody @Validated(InsertCheck.class) ApsGoodsForecastUserGoodsDataInsertReq req);

  /**
   * 根据ID 删除
   */
  @PostMapping("/apsGoodsForecastUserGoodsData/deleteByIdList")
  ApsGoodsForecastUserGoodsDataDeleteByIdListRes deleteByIdList(
      @RequestBody @Valid ApsGoodsForecastUserGoodsDataDeleteByIdListReq req);

  /**
   * 查询
   */
  @PostMapping("/apsGoodsForecastUserGoodsData/queryList")
  ApsGoodsForecastUserGoodsDataQueryListRes queryList(
      @RequestBody @Valid ApsGoodsForecastUserGoodsDataQueryListReq req);

  /**
   * 根据ID 更新
   */
  @PostMapping("/apsGoodsForecastUserGoodsData/updateById")
  ApsGoodsForecastUserGoodsDataUpdateByIdRes updateById(
      @RequestBody @Validated(UpdateCheck.class) ApsGoodsForecastUserGoodsDataUpdateByIdReq req);

  /**
   * 分页查询
   */
  @PostMapping("/apsGoodsForecastUserGoodsData/queryPageList")
  DynamicsPage<ApsGoodsForecastUserGoodsDataExportQueryPageListInfoRes> queryPageList(
      @RequestBody @Valid ApsGoodsForecastUserGoodsDataExportQueryPageListReq req);
  ...
  ApsGoodsForecastUserGoodsDataQueryByIdListRes queryByIdListRes(
      @RequestBody @Valid ApsGoodsForecastUserGoodsDataQueryByIdListReq req);
