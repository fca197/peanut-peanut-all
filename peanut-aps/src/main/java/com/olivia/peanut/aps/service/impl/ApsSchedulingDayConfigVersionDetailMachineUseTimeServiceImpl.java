...
@Transactional
public class ApsSchedulingDayConfigVersionDetailMachineUseTimeServiceImpl extends
    MPJBaseServiceImpl<ApsSchedulingDayConfigVersionDetailMachineUseTimeMapper, ApsSchedulingDayConfigVersionDetailMachineUseTime> implements
    ApsSchedulingDayConfigVersionDetailMachineUseTimeService {
  ...
  public @Override ApsSchedulingDayConfigVersionDetailMachineUseTimeQueryListRes queryList(ApsSchedulingDayConfigVersionDetailMachineUseTimeQueryListReq req) {
    ...
    MPJLambdaWrapper<ApsSchedulingDayConfigVersionDetailMachineUseTime> q = getWrapper(
        req.getData());
    List<ApsSchedulingDayConfigVersionDetailMachineUseTime> list = this.list(q);

    List<ApsSchedulingDayConfigVersionDetailMachineUseTimeDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsSchedulingDayConfigVersionDetailMachineUseTimeDto.class))
        .collect(Collectors.toList());
    ((ApsSchedulingDayConfigVersionDetailMachineUseTimeService) AopContext.currentProxy()).setName(
        dataList);
    return new ApsSchedulingDayConfigVersionDetailMachineUseTimeQueryListRes().setDataList(
        dataList);
  }
  ...
  public @Override DynamicsPage<ApsSchedulingDayConfigVersionDetailMachineUseTimeExportQueryPageListInfoRes> queryPageList(
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsSchedulingDayConfigVersionDetailMachineUseTimeExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t,
    ...
    List<ApsSchedulingDayConfigVersionDetailMachineUseTimeExportQueryPageListInfoRes> listInfoRes = $.copyList(
        records, ApsSchedulingDayConfigVersionDetailMachineUseTimeExportQueryPageListInfoRes.class);
    ((ApsSchedulingDayConfigVersionDetailMachineUseTimeService) AopContext.currentProxy()).setName(
        listInfoRes);
  ...
  public @Override void setName(
      List<? extends ApsSchedulingDayConfigVersionDetailMachineUseTimeDto> list) {
  ...
  private MPJLambdaWrapper<ApsSchedulingDayConfigVersionDetailMachineUseTime> getWrapper(ApsSchedulingDayConfigVersionDetailMachineUseTimeDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getSchedulingDayId()),
              ApsSchedulingDayConfigVersionDetailMachineUseTime::getSchedulingDayId,
              obj.getSchedulingDayId())
          .eq(Objects.nonNull(obj.getMachineId()),
              ApsSchedulingDayConfigVersionDetailMachineUseTime::getMachineId, obj.getMachineId())
          .eq(Objects.nonNull(obj.getUseTime()),
              ApsSchedulingDayConfigVersionDetailMachineUseTime::getUseTime, obj.getUseTime())
          .eq(Objects.nonNull(obj.getUseUsageRate()),
              ApsSchedulingDayConfigVersionDetailMachineUseTime::getUseUsageRate,
              obj.getUseUsageRate())
          .eq(Objects.nonNull(obj.getMakeProduceCount()),
              ApsSchedulingDayConfigVersionDetailMachineUseTime::getMakeProduceCount,
              obj.getMakeProduceCount())
  ...
  private void setQueryListHeader(
      DynamicsPage<ApsSchedulingDayConfigVersionDetailMachineUseTime> page) {

    tableHeaderService.listByBizKey(page,
        "ApsSchedulingDayConfigVersionDetailMachineUseTimeService#queryPageList");
