...
//    return new ApsRollingForecastFactoryCapacityInsertRes().setCount(1);
  ...
  public @Override ApsRollingForecastFactoryCapacityQueryByIdListRes queryByIdListRes(ApsRollingForecastFactoryCapacityQueryByIdListReq req) {
    MPJLambdaWrapper<ApsRollingForecastFactoryCapacity> q = new MPJLambdaWrapper<ApsRollingForecastFactoryCapacity>(ApsRollingForecastFactoryCapacity.class).selectAll(ApsRollingForecastFactoryCapacity.class).in(ApsRollingForecastFactoryCapacity::getId, req.getIdList());
