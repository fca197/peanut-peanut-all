...
@Transactional
public class ApsGoodsBomBuyPlanServiceImpl extends MPJBaseServiceImpl<ApsGoodsBomBuyPlanMapper, ApsGoodsBomBuyPlan> implements
    ApsGoodsBomBuyPlanService {
  ...
  public @Override ApsGoodsBomBuyPlanQueryListRes queryList(ApsGoodsBomBuyPlanQueryListReq req) {
    ...
    List<ApsGoodsBomBuyPlanDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsGoodsBomBuyPlanDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsGoodsBomBuyPlanExportQueryPageListInfoRes> queryPageList(ApsGoodsBomBuyPlanExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsGoodsBomBuyPlanExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsGoodsBomBuyPlanExportQueryPageListInfoRes.class));
    ...
    List<ApsGoodsBomBuyPlanExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
  ...
  private MPJLambdaWrapper<ApsGoodsBomBuyPlan> getWrapper(ApsGoodsBomBuyPlanDto obj) {
    ...
    LambdaQueryUtil.lambdaQueryWrapper(q, obj, ApsGoodsBomBuyPlan.class,
        ApsGoodsBomBuyPlan::getPlanName, ApsGoodsBomBuyPlan::getPlanSource);
