...
public class ApsOrderGoodsForecastMakeServiceImpl extends MPJBaseServiceImpl<ApsOrderGoodsForecastMakeMapper, ApsOrderGoodsForecastMake> implements
  ...
  public @Override ApsOrderGoodsForecastMakeQueryListRes queryList(ApsOrderGoodsForecastMakeQueryListReq req) {
    ...
    List<ApsOrderGoodsForecastMakeDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsOrderGoodsForecastMakeDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsOrderGoodsForecastMakeExportQueryPageListInfoRes> queryPageList(ApsOrderGoodsForecastMakeExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsOrderGoodsForecastMakeExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsOrderGoodsForecastMakeExportQueryPageListInfoRes.class));
    ...
    List<ApsOrderGoodsForecastMakeExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
        ApsOrderGoodsForecastMakeExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsOrderGoodsForecastMakeDto> apsOrderGoodsForecastMakeDtoList) {
  ...
  private MPJLambdaWrapper<ApsOrderGoodsForecastMake> getWrapper(ApsOrderGoodsForecastMakeDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getOrderId()), ApsOrderGoodsForecastMake::getOrderId,
              obj.getOrderId())
          .eq(Objects.nonNull(obj.getGoodsId()), ApsOrderGoodsForecastMake::getGoodsId,
              obj.getGoodsId())
          .eq(Objects.nonNull(obj.getGoodsStatusId()), ApsOrderGoodsForecastMake::getGoodsStatusId,
              obj.getGoodsStatusId())
          .eq(StringUtils.isNoneBlank(obj.getGoodsStatusName()),
              ApsOrderGoodsForecastMake::getGoodsStatusName, obj.getGoodsStatusName())
          .eq(Objects.nonNull(obj.getForecastMakeDate()),
              ApsOrderGoodsForecastMake::getForecastMakeDate, obj.getForecastMakeDate())
          .eq(Objects.nonNull(obj.getFactoryId()), ApsOrderGoodsForecastMake::getFactoryId,
              obj.getFactoryId())
