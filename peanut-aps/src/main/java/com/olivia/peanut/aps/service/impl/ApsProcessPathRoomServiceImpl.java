...
public class ApsProcessPathRoomServiceImpl extends MPJBaseServiceImpl<ApsProcessPathRoomMapper, ApsProcessPathRoom> implements
  ...
  public @Override ApsProcessPathRoomQueryListRes queryList(ApsProcessPathRoomQueryListReq req) {
    ...
    List<ApsProcessPathRoomDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsProcessPathRoomDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsProcessPathRoomExportQueryPageListInfoRes> queryPageList(ApsProcessPathRoomExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsProcessPathRoomExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsProcessPathRoomExportQueryPageListInfoRes.class));
    ...
    List<ApsProcessPathRoomExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
  ...
  private MPJLambdaWrapper<ApsProcessPathRoom> getWrapper(ApsProcessPathRoomDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getProcessPathId()), ApsProcessPathRoom::getProcessPathId,
              obj.getProcessPathId())
          .eq(Objects.nonNull(obj.getRoomId()), ApsProcessPathRoom::getRoomId, obj.getRoomId())
          .eq(Objects.nonNull(obj.getFactoryId()), ApsProcessPathRoom::getFactoryId,
              obj.getFactoryId())
