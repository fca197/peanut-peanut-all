...
public class ApsGoodsForecastMakeProjectDataApiImpl implements ApsGoodsForecastMakeProjectDataApi {
  ...
  public @Override ApsGoodsForecastMakeProjectDataQueryByIdListRes queryByIdListRes(ApsGoodsForecastMakeProjectDataQueryByIdListReq req) {
    MPJLambdaWrapper<ApsGoodsForecastMakeProjectData> q = new MPJLambdaWrapper<ApsGoodsForecastMakeProjectData>(ApsGoodsForecastMakeProjectData.class).selectAll(ApsGoodsForecastMakeProjectData.class).in(ApsGoodsForecastMakeProjectData::getId, req.getIdList());
