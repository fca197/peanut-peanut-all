...
public class ApsMakeCapacitySaleConfigServiceImpl extends MPJBaseServiceImpl<ApsMakeCapacitySaleConfigMapper, ApsMakeCapacitySaleConfig> implements
  ...
  public @Override ApsMakeCapacitySaleConfigQueryListRes queryList(ApsMakeCapacitySaleConfigQueryListReq req) {
    ...
    List<ApsMakeCapacitySaleConfigDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsMakeCapacitySaleConfigDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsMakeCapacitySaleConfigExportQueryPageListInfoRes> queryPageList(ApsMakeCapacitySaleConfigExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsMakeCapacitySaleConfigExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsMakeCapacitySaleConfigExportQueryPageListInfoRes.class));
    ...
    List<ApsMakeCapacitySaleConfigExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
  ...
  public ApsMakeCapacitySaleConfigInsertRes save(ApsMakeCapacitySaleConfigInsertReq req) {
    Map<String, ApsMakeCapacitySaleConfig> apsMakeCapacityFactoryMap = this.list(
            new LambdaQueryWrapper<ApsMakeCapacitySaleConfig>()
...
//    Map<String, ApsMakeCapacityFactory> apsMakeCapacityFactoryMap = new HashMap<>();
    ...
    for (int i = 0; i < size; i++) {
      ...
      localDateBetween.forEach(currentDate -> {
        ...
        ApsMakeCapacitySaleConfig makeCapacityFactory = apsMakeCapacityFactoryMap.getOrDefault(key,
            new ApsMakeCapacitySaleConfig());
        makeCapacityFactory.setSaleConfigId(req.getSaleConfigId()).setYear(currentDate.getYear())
    ...
    List<ApsMakeCapacitySaleConfig> updateList = entityList.stream()
        .filter(t -> Objects.nonNull(t.getId())).toList();
    if (CollUtil.isNotEmpty(updateList)) {
      this.updateBatchById(updateList);
    }
    List<ApsMakeCapacitySaleConfig> insertList = entityList.stream()
  ...
  public @Override void setName(
      List<? extends ApsMakeCapacitySaleConfigDto> apsMakeCapacitySaleConfigDtoList) {
    ...
    apsMakeCapacitySaleConfigDtoList.forEach(
        t -> t.setSaleConfigName(snMap.get(t.getSaleConfigId())));
  ...
  private MPJLambdaWrapper<ApsMakeCapacitySaleConfig> getWrapper(ApsMakeCapacitySaleConfigDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getSaleConfigId()), ApsMakeCapacitySaleConfig::getSaleConfigId,
              obj.getSaleConfigId())
          .eq(Objects.nonNull(obj.getMakeCapacityQuantity()),
              ApsMakeCapacitySaleConfig::getMakeCapacityQuantity, obj.getMakeCapacityQuantity())
