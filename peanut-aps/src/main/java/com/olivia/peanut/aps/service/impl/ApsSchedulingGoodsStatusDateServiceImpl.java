...
public class ApsSchedulingGoodsStatusDateServiceImpl extends MPJBaseServiceImpl<ApsSchedulingGoodsStatusDateMapper, ApsSchedulingGoodsStatusDate> implements
  ...
  public @Override ApsSchedulingGoodsStatusDateQueryListRes queryList(ApsSchedulingGoodsStatusDateQueryListReq req) {
    ...
    List<ApsSchedulingGoodsStatusDateDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsSchedulingGoodsStatusDateDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsSchedulingGoodsStatusDateExportQueryPageListInfoRes> queryPageList(ApsSchedulingGoodsStatusDateExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsSchedulingGoodsStatusDateExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsSchedulingGoodsStatusDateExportQueryPageListInfoRes.class));
    ...
    List<ApsSchedulingGoodsStatusDateExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
        ApsSchedulingGoodsStatusDateExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsSchedulingGoodsStatusDateDto> apsSchedulingGoodsStatusDateDtoList) {
  ...
  private MPJLambdaWrapper<ApsSchedulingGoodsStatusDate> getWrapper(ApsSchedulingGoodsStatusDateDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getSchedulingId()), ApsSchedulingGoodsStatusDate::getSchedulingId,
              obj.getSchedulingId())
          .eq(Objects.nonNull(obj.getOrderId()), ApsSchedulingGoodsStatusDate::getOrderId,
              obj.getOrderId())
          .eq(Objects.nonNull(obj.getGoodsId()), ApsSchedulingGoodsStatusDate::getGoodsId,
              obj.getGoodsId())
          .eq(Objects.nonNull(obj.getGoodsStatusId()),
              ApsSchedulingGoodsStatusDate::getGoodsStatusId, obj.getGoodsStatusId())
          .eq(Objects.nonNull(obj.getFactoryId()), ApsSchedulingGoodsStatusDate::getFactoryId,
              obj.getFactoryId())
          .eq(Objects.nonNull(obj.getStatusIndex()), ApsSchedulingGoodsStatusDate::getStatusIndex,
              obj.getStatusIndex())
