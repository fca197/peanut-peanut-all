...
public class ApsGoodsForecastComputeSaleDataServiceImpl extends MPJBaseServiceImpl<ApsGoodsForecastComputeSaleDataMapper, ApsGoodsForecastComputeSaleData> implements
  ...
  public @Override ApsGoodsForecastComputeSaleDataQueryListRes queryList(ApsGoodsForecastComputeSaleDataQueryListReq req) {
    ...
    List<ApsGoodsForecastComputeSaleDataDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsGoodsForecastComputeSaleDataDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsGoodsForecastComputeSaleDataExportQueryPageListInfoRes> queryPageList(ApsGoodsForecastComputeSaleDataExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsGoodsForecastComputeSaleDataExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsGoodsForecastComputeSaleDataExportQueryPageListInfoRes.class));
      records = dataList.getRecords();
    } else {
      records = $.copyList(this.list(q),
          ApsGoodsForecastComputeSaleDataExportQueryPageListInfoRes.class);
    }

    // 类型转换，  更换枚举 等操作

    List<ApsGoodsForecastComputeSaleDataExportQueryPageListInfoRes> listInfoRes = $.copyList(
        records, ApsGoodsForecastComputeSaleDataExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsGoodsForecastComputeSaleDataDto> apsGoodsForecastComputeSaleDataDtoList) {
  ...
  private MPJLambdaWrapper<ApsGoodsForecastComputeSaleData> getWrapper(ApsGoodsForecastComputeSaleDataDto obj) {
    ...
    LambdaQueryUtil.lambdaQueryWrapper(q, obj, ApsGoodsForecastComputeSaleData.class //
        , ApsGoodsForecastComputeSaleData::getForecastId,
        ApsGoodsForecastComputeSaleData::getSaleConfigId,
