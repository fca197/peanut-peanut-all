...
public class ApsGoodsSaleProjectConfigApiImpl implements ApsGoodsSaleProjectConfigApi {
  ...
  public @Override ApsGoodsSaleProjectConfigImportRes importData(@RequestParam("file") MultipartFile file) {
    List<ApsGoodsSaleProjectConfigImportReq> reqList = PoiExcelUtil.readData(file, new ApsGoodsSaleProjectConfigImportListener(),
        ApsGoodsSaleProjectConfigImportReq.class);
    // 类型转换，  更换枚举 等操作
  ...
  public @Override ApsGoodsSaleProjectConfigQueryByIdListRes queryByIdListRes(ApsGoodsSaleProjectConfigQueryByIdListReq req) {
    MPJLambdaWrapper<ApsGoodsSaleProjectConfig> q = new MPJLambdaWrapper<ApsGoodsSaleProjectConfig>(ApsGoodsSaleProjectConfig.class).selectAll(ApsGoodsSaleProjectConfig.class).in(ApsGoodsSaleProjectConfig::getId, req.getIdList());
  ...
  public ApsGoodsSaleProjectConfigInsertRes insertBatch(List<ApsGoodsSaleProjectConfigInsertReq> req) {
    ...
    this.apsGoodsSaleProjectConfigService.remove(new LambdaQueryWrapper<ApsGoodsSaleProjectConfig>().in(ApsGoodsSaleProjectConfig::getGoodsId,
