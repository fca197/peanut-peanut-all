...
@Transactional
public class ApsSchedulingVersionItemServiceImpl extends MPJBaseServiceImpl<ApsSchedulingVersionItemMapper, ApsSchedulingVersionItem> implements
    ApsSchedulingVersionItemService {
  ...
  public @Override ApsSchedulingVersionItemQueryListRes queryList(ApsSchedulingVersionItemQueryListReq req) {
    ...
    List<ApsSchedulingVersionItemDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsSchedulingVersionItemDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsSchedulingVersionItemExportQueryPageListInfoRes> queryPageList(ApsSchedulingVersionItemExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsSchedulingVersionItemExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsSchedulingVersionItemExportQueryPageListInfoRes.class));
    ...
    List<ApsSchedulingVersionItemExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
        ApsSchedulingVersionItemExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsSchedulingVersionItemDto> apsSchedulingVersionItemDtoList) {
