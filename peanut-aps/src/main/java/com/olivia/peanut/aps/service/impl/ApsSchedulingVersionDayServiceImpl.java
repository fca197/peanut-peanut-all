...
@Transactional
public class ApsSchedulingVersionDayServiceImpl extends MPJBaseServiceImpl<ApsSchedulingVersionDayMapper, ApsSchedulingVersionDay> implements
  ...
  public @Override ApsSchedulingVersionDayQueryListRes queryList(ApsSchedulingVersionDayQueryListReq req) {
    ...
    List<ApsSchedulingVersionDayDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsSchedulingVersionDayDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsSchedulingVersionDayExportQueryPageListInfoRes> queryPageList(ApsSchedulingVersionDayExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsSchedulingVersionDayExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsSchedulingVersionDayExportQueryPageListInfoRes.class));
    ...
    List<ApsSchedulingVersionDayExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
        ApsSchedulingVersionDayExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsSchedulingVersionDayDto> apsSchedulingVersionDayDtoList) {
  ...
  private MPJLambdaWrapper<ApsSchedulingVersionDay> getWrapper(ApsSchedulingVersionDayDto obj) {
    ...
    LambdaQueryUtil.lambdaQueryWrapper(q, obj, ApsSchedulingVersionDay.class,
        ApsSchedulingVersionDay::getVersionId
