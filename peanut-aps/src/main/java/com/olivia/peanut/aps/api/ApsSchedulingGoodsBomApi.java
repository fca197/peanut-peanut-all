...
public interface ApsSchedulingGoodsBomApi {
  ...
  ApsSchedulingGoodsBomInsertRes insert(
      @RequestBody @Validated(InsertCheck.class) ApsSchedulingGoodsBomInsertReq req);

  /**
   * 根据ID 删除 订单商品零件表
   */
  @PostMapping("/apsSchedulingGoodsBom/deleteByIdList")
  ApsSchedulingGoodsBomDeleteByIdListRes deleteByIdList(
      @RequestBody @Valid ApsSchedulingGoodsBomDeleteByIdListReq req);

  /**
   * 查询 订单商品零件表
   */
  @PostMapping("/apsSchedulingGoodsBom/queryList")
  ApsSchedulingGoodsBomQueryListRes queryList(
      @RequestBody @Valid ApsSchedulingGoodsBomQueryListReq req);

  /**
   * 根据ID 更新 订单商品零件表
   */
  @PostMapping("/apsSchedulingGoodsBom/updateById")
  ApsSchedulingGoodsBomUpdateByIdRes updateById(
      @RequestBody @Validated(UpdateCheck.class) ApsSchedulingGoodsBomUpdateByIdReq req);
  ...
  DynamicsPage<ApsSchedulingGoodsBomExportQueryPageListInfoRes> queryPageList(
      @RequestBody @Valid ApsSchedulingGoodsBomExportQueryPageListReq req);
  ...
  ApsSchedulingGoodsBomQueryByIdListRes queryByIdListRes(
      @RequestBody @Valid ApsSchedulingGoodsBomQueryByIdListReq req);
