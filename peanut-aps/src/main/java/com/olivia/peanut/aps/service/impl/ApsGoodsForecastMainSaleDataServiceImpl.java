...
public class ApsGoodsForecastMainSaleDataServiceImpl extends MPJBaseServiceImpl<ApsGoodsForecastMainSaleDataMapper, ApsGoodsForecastMainSaleData> implements
  ...
  public @Override ApsGoodsForecastMainSaleDataQueryListRes queryList(ApsGoodsForecastMainSaleDataQueryListReq req) {
    ...
    List<ApsGoodsForecastMainSaleDataDto> dataList = list.stream()
        .map(t -> $.copy(t, ApsGoodsForecastMainSaleDataDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsGoodsForecastMainSaleDataExportQueryPageListInfoRes> queryPageList(ApsGoodsForecastMainSaleDataExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsGoodsForecastMainSaleDataExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsGoodsForecastMainSaleDataExportQueryPageListInfoRes.class));
    ...
    List<ApsGoodsForecastMainSaleDataExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
        ApsGoodsForecastMainSaleDataExportQueryPageListInfoRes.class);
  ...
  public @Override void setName(
      List<? extends ApsGoodsForecastMainSaleDataDto> apsGoodsForecastMainSaleDataDtoList) {
  ...
  private MPJLambdaWrapper<ApsGoodsForecastMainSaleData> getWrapper(ApsGoodsForecastMainSaleDataDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getGoodsId()), ApsGoodsForecastMainSaleData::getGoodsId,
              obj.getGoodsId())
          .eq(StringUtils.isNoneBlank(obj.getSaleConfigCode()),
              ApsGoodsForecastMainSaleData::getSaleConfigCode, obj.getSaleConfigCode())
